            ...
            this.options.dataSource(treeData ? treeData : {}, function (items) {
                ...
                $.each(items.data, function (index, value) {
                    ...
                    if (value.Type === 'folder') {
                        ...
                        //WebEd parsing data
                        var folderTemplate = self.options['folderTemplate'];
                        folderTemplate = replaceDocumentData(folderTemplate, value.Data);
                        header.append(folderTemplate);
                        ...
                        var fileTemplate = self.options['fileTemplate'];
                        fileTemplate = replaceDocumentData(fileTemplate, value.Data);
                        $entity.append(fileTemplate);
                    }

                    // add attributes to tree-branch or tree-item
                    var data = value['Data'] || value.dataAttributes || [];
