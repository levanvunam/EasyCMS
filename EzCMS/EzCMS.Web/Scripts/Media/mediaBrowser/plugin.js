...
tinymce.PluginManager.add('mediaBrowser', function (editor) {
    ...
    function showDialog(imageList) {
        ...
        function openMediaBrowser() {
            var imgSrc = win.find("#src")[0];
            
            // Open the browser here
            if (window.openMediaBrowser) {
                window.openMediaBrowser(function (outputLink) {
                    // set val to img box
                    imgSrc.value(outputLink);
                });
            }
        }
        ...
        var generalFormItems = [
        {
            ...
            spacing: 5,
            items: [
                    { name: 'src', type: 'textbox', filetype: 'image', size: 10, label: 'Source', autofocus: true },
                    { name: 'btnBrowse', type: 'button', text: 'Select', autofocus: true, onClick: openMediaBrowser },
                ]
            },
			imageListCtrl,
    ...
    editor.addMenuItem('mediaBrowser', {
        icon: 'image',
        text: 'Select/Insert image',
        onclick: createImageList(showDialog),
        context: 'insert',
