...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        //WebEd fix
        //Adding drag and drop disable option
        dragAndDropFile: true,
        removeDragTemplate: '<div class="qq-uploader">' +
                '<div class="qq-upload-button">{uploadButtonText}</div>' +
                '<ul class="qq-upload-list"></ul>' +
             '</div>',
        //Adding caculating leaving document
        checkLeavingDocument: null
    });
    ...
    if (this._options.dragAndDropFile) {
        this._options.template = this._options.template.replace(/\{dragText\}/g, this._options.dragText);
        this._options.template = this._options.template.replace(/\{uploadButtonText\}/g, this._options.uploadButtonText);
    } else {
        this._options.removeDragTemplate = this._options.removeDragTemplate.replace(/\{uploadButtonText\}/g, this._options.uploadButtonText);
    }
    ...
    if (this._options.dragAndDropFile) {
        ...
        this._element.innerHTML = this._options.removeDragTemplate;
    }
    ...
    _setupDragDrop: function(){
        if (this._options.dragAndDropFile) {
            ...
            this._attach(document, 'dragleave', function (e) {
                //WebEd fix: adding leaving document function
                if (self._options.checkLeavingDocument != undefined && self._options.checkLeavingDocument != null && typeof self._options.checkLeavingDocument == "function") {
                    if (self._options.hideShowDropArea && self._options.checkLeavingDocument(e)) {
    ...
    _bindCancelEvent: function(){
        ...
        this._attach(list, 'click', function(e){
            ...
            if (qq.hasClass(target, self._classes.cancel)){
                ...
                var drop = target.parentNode.closest(".qq-upload-drop-area");
                console.log(drop);
                drop.hide();
            }
        });
