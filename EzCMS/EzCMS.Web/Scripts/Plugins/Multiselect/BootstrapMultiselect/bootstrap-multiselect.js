    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                var iconHtml = ' <span class="fa fa-angle-down icon-on-right bigger-110"></span>';
                if (options.length === 0) {
                    return this.nonSelectedText + iconHtml;
                }
                else if (options.length == $('option', $(select)).length) {
                    return this.allSelectedText + iconHtml;
                }
                else if (options.length > this.numberDisplayed) {
                    return options.length + ' ' + this.nSelectedText + iconHtml;
                }
                else {
                    var selected = '';
                    ...
                    return selected.substr(0, selected.length - 2) + iconHtml;
                }
            },
            /**
