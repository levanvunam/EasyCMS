...
CKEDITOR.plugins.add('ezcms_widget', {
    ...
    init: function (editor) {
        ...
        // Register the ezcms_widget widget.
        editor.widgets.add('ezcms_widget', {
            ...
            // editor.lang.ezcms_widget.* property. A string was used directly here to simplify this tutorial.
            button: 'Widget',

            // Set the widget dialog window name. This enables the automatic widget-dialog binding.
            // This dialog window will be opened when creating a new widget or editing an existing one.
            dialog: 'ezcms_widget_dialog',
            ...
            upcast: function (element) {
                ...
                // for all <div> elements with a "ezcms_widget" class.
            ...
            data: function () {
                ...
                // The style is set on widget main element (div.ezcms_widget).
                if (this.data.widget == '')
